...
returns <- ifelse(percent_change > ((2506.85 - 2673.61)/2506.85), "High", "Low")
...
--Categorical Variables (3): 'Ticker Symbol,' 'S&P500 Sector,' and 'Returns' (did the stock price percent change outperform the S&P500 percent change within the same timeframe?)

--Continuous Variables (20): 'Assets,' 'Asset Turnover,' 'Cash and Equivalents,' 'Earning Before Interest & Taxes,' 'Earnings Before Interest, Taxes & Depreciation Amortization Margin,' 'Enterprise Value vs Earnings Before Interest, Taxes & Depreciation Amortization,' 'Equity,' 'Gross Profit,' 'Gross Margin,' 'Liabilities,' 'Net Income,' 'Profit Margin,' 'Operating Income,' 'Revenue,' 'Return on Average Assets,' 'Return on Average Equity,' 'Return on Invested Capital,' 'Return on Sales,' 'Percent Change in Stock Price between 12/31/17 and 12/31/18' 
...
--First Principal Component Major Contributors: Assets (0.3302195), Ebit (0.3427073), Equity (0.3113194), Ev (0.3096712), Gp (0.3344644), Liabilities (0.3175236), Netinc (0.3004678), Opinc (0.3393669), Revenue (0.3063073)

*It seems that all of these variables deal with ...* 


--Second Principal Component Major Contributors: Assetturnover (-0.4576183), Ebitdamargin (0.4143826), Grossmargin (0.3299659), Netmargin (0.3255007), Ros (0.3877188)

*It seems that all of these variables deal with ...* 

--Third Principal Component Major Contributors: Netmargin (-0.3604086), Roa (-0.4972653), Roe (-0.4591578), Roic (-0.3446799)

*It seems that all of these variables deal with ...* 

--Fourth Principal Component Major Contributors: Cashneq (-0.3541464), Ev_ebitda (-0.6414379), Grossmargin (-0.3866646), Roic (-0.3104997)
...
\\ NEED TO DISCUSS AS A GROUP WHAT THIS MEANS
...
success_rate
```
Leaving out one point, and predicting its group using the k-nearest neighbor method, and repeating this for all 331 points in our dataset, this method predicts the group with an approximately 57.8% success rate.

Support-Vector Machine, ML binary classification method, with k-fold (30) cross-validation
```{r}
