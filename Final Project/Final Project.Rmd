...
```{r}
# partimat(as.factor(group.QDA)~assets+assetturnover+cashneq+ebit+ebitdamargin+ev_ebitda+equity+ev+gp+grossmargin+liabilities+netinc+netmargin+opinc+revenue+roa+roe+roic+ros, data=data.QDA, method="qda") 
