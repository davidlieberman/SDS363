...
success_rate
```
Leaving out one point, and predicting its group using the k-nearest neighbor method, and repeating this for all 331 points in our dataset, this method predicts the group with approximately 57.8% success rate.
