...
```{r}
#version 1
corrplot(cor(data_transformed), method = "color", tl.cex=0.6)
#version 2
corrplot.mixed(cor(data_transformed), lower.col="black", upper = "ellipse", tl.col = "black", number.cex=0.5, order = "hclust",tl.pos = "lt", tl.cex=0.6)
```
