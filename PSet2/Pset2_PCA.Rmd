...
author: "Ryo Tamaki, David Lieberman, Ramiz Çolak, Liana Wang"
...
cleaned_drug <- data_transformed[complete.cases(data_transformed),]
CSQPlot(cleaned_drug, label="Drug Attitudes")
```
