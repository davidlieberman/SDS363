...
```{r}
data <- read.csv("https://gist.githubusercontent.com/davidlieberman/dcfeffdd1b047d20ca63345a7bd7104b/raw/9183d734c911c05bf1e63b7ff480cdd8d98bfd9f/fundimentals.csv")
colnames(data)
nrow(data)
```
